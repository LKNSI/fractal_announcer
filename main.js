const main = async () => {
    ...
    class fractal_announcer {
        ...
        async send_message(){
            ...
            this.client.channels.fetch(settings.channel_id).then(channel => channel.send(`Welcome to the Fractal Discord! If you are new here, please visit 👉 #start-here to get started and to assign your roles. 
